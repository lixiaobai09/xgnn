...
dataset="com-friendster"
# for graphsage
CUDA_VISIBLE_DEVICES=0,1,2,3 python ${sgnn_dir}/train_graphsage.py --num-worker 4 --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --use-ics22-song-solver --clique-size 4 --ics22-song-alpha 0.4 --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.23 > ${log_dir}/xgnn_graphsage_cf_4g_1_ics22_break.log 2> ${log_dir}/xgnn_graphsage_cf_4g_1_ics22_break.log.err
CUDA_VISIBLE_DEVICES=0,1,6,7 python ${sgnn_dir}/train_graphsage.py --num-worker 4 --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --use-ics22-song-solver --clique-size 2 --ics22-song-alpha 0.4 --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.13 > ${log_dir}/xgnn_graphsage_cf_4g_2_ics22_break.log 2> ${log_dir}/xgnn_graphsage_cf_4g_2_ics22_break.log.err
python ${sgnn_dir}/train_graphsage.py --num-worker 8 --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --use-ics22-song-solver --clique-size 4 --ics22-song-alpha 0.4 --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.23 > ${log_dir}/xgnn_graphsage_cf_8g_ics22_break.log 2> ${log_dir}/xgnn_graphsage_cf_8g_ics22_break.log.err
