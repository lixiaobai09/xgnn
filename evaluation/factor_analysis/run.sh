...
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop0 --use-dist-graph 1.0 --gpu-extract --cache-percentage 0.18 > ${log_dir}/xgnn_gcn_pa_2.log 2> ${log_dir}/xgnn_gcn_pa_2.log.err
...
python ${sgnn_dir}/train_graphsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop0 --use-dist-graph 1.0 --gpu-extract --cache-percentage 0.13 > ${log_dir}/xgnn_graphsage_uk_2.log 2> ${log_dir}/xgnn_graphsage_uk_2.log.err
...
python ${sgnn_dir}/train_graphsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop0 --use-dist-graph 1.0 --gpu-extract --cache-percentage 0.24 > ${log_dir}/xgnn_graphsage_cf_2.log 2> ${log_dir}/xgnn_graphsage_cf_2.log.err
