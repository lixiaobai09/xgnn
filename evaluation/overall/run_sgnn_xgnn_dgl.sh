...
dataset="twitter"
# for gcn
# python ${dgl_dir}/train_gcn.py --devices ${dgl_devices} --num-epoch ${num_epoch} --dataset ${dataset} --use-gpu-sampling --use-uva-feat > ${log_dir}/dgl_gcn_tw.log 2> ${log_dir}/dgl_gcn_tw.log.err
...
# # for graphsage
# python ${dgl_dir}/train_graphsage.py --devices ${dgl_devices} --num-epoch ${num_epoch} --dataset ${dataset} --use-gpu-sampling --use-uva-feat > ${log_dir}/dgl_graphsage_tw.log 2> ${log_dir}/dgl_graphsage_tw.log.err
...
# # for pinsage
# python ${dgl_dir}/train_pinsage.py --devices ${dgl_devices} --num-epoch ${num_epoch} --dataset ${dataset} --use-gpu-sampling --use-uva-feat > ${log_dir}/dgl_pinsage_tw.log 2> ${log_dir}/dgl_pinsage_tw.log.err
...
dataset="papers100M"
# for gcn
# # python ${dgl_dir}/train_gcn.py --devices ${dgl_devices} --num-epoch ${num_epoch} --dataset ${dataset} --use-gpu-sampling --use-uva-feat > ${log_dir}/dgl_gcn_pa.log 2> ${log_dir}/dgl_gcn_pa.log.err
...
# # for graphsage
# # python ${dgl_dir}/train_graphsage.py --devices ${dgl_devices} --num-epoch ${num_epoch} --dataset ${dataset} --use-gpu-sampling --use-uva-feat > ${log_dir}/dgl_graphsage_pa.log 2> ${log_dir}/dgl_graphsage_pa.log.err
...
# # for pinsage
# # python ${dgl_dir}/train_pinsage.py --devices ${dgl_devices} --num-epoch ${num_epoch} --dataset ${dataset} --use-gpu-sampling --use-uva-feat > ${log_dir}/dgl_pinsage_pa.log 2> ${log_dir}/dgl_pinsage_pa.log.err
