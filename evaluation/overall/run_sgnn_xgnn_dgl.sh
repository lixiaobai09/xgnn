...
dataset="com-friendster"
# for gcn
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 0.7 --cache-percentage 0.30 > ${log_dir}/xgnn_gcn_cf_break.log 2> ${log_dir}/xgnn_gcn_cf_break.log.err
# for graphsage
