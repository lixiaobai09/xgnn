...
dataset="twitter"
# for gcn
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop0 --gpu-extract --cache-percentage 0.10 > ${log_dir}/sgnn_gcn_tw_break.log 2> ${log_dir}/sgnn_gcn_tw_break.log.err
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.81 > ${log_dir}/xgnn_gcn_tw_break.log 2> ${log_dir}/xgnn_gcn_tw_break.log.err
# for graphsage
...
python ${sgnn_dir}/train_pinsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --gpu-extract --part-cache --use-dist-graph 1.0 --cache-percentage 0.85 > ${log_dir}/xgnn_pinsage_tw_break.log 2> ${log_dir}/xgnn_pinsage_tw_break.log.err
...
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.71 > ${log_dir}/xgnn_gcn_pa_break.log 2> ${log_dir}/xgnn_gcn_pa_break.log.err
# # for graphsage
...
python ${sgnn_dir}/train_graphsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.83 > ${log_dir}/xgnn_graphsage_pa_break.log 2> ${log_dir}/xgnn_graphsage_pa_break.log.err
# # for pinsage
python ${sgnn_dir}/train_pinsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --gpu-extract --cache-percentage 0.09 > ${log_dir}/sgnn_pinsage_pa_break.log 2> ${log_dir}/sgnn_pinsage_pa_break.log.err
python ${sgnn_dir}/train_pinsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --gpu-extract --part-cache --use-dist-graph 1.0 --cache-percentage 0.73 > ${log_dir}/xgnn_pinsage_pa_break.log 2> ${log_dir}/xgnn_pinsage_pa_break.log.err

dataset="uk-2006-05"
# for gcn
# pipeline will OOM
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.43 > ${log_dir}/xgnn_gcn_uk_break.log 2> ${log_dir}/xgnn_gcn_uk_break.log.err
# # for graphsage
...
python ${sgnn_dir}/train_graphsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.52 > ${log_dir}/xgnn_graphsage_uk_break.log 2> ${log_dir}/xgnn_graphsage_uk_break.log.err
# # for pinsage
...
dataset="com-friendster"
# for gcn
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.21 > ${log_dir}/xgnn_gcn_cf_break.log 2> ${log_dir}/xgnn_gcn_cf_break.log.err
# for graphsage
python ${sgnn_dir}/train_graphsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.96 > ${log_dir}/xgnn_graphsage_cf_break.log 2> ${log_dir}/xgnn_graphsage_cf_break.log.err
# for pinsage
