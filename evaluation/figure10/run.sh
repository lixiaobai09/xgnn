...
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.79 > ${log_dir}/xgnn_gcn_tw_5.log 2> ${log_dir}/xgnn_gcn_tw_5.log.err
...
python ${sgnn_dir}/train_gcn.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.69 > ${log_dir}/xgnn_gcn_pa_5.log 2> ${log_dir}/xgnn_gcn_pa_5.log.err
...
python ${sgnn_dir}/train_graphsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.51 > ${log_dir}/xgnn_graphsage_uk_5.log 2> ${log_dir}/xgnn_graphsage_uk_5.log.err
...
python ${sgnn_dir}/train_graphsage.py --num-worker ${num_worker} --cache-policy degree --batch-size 6000 --num-epoch ${num_epoch} --dataset ${dataset} --sample-type khop3 --part-cache --gpu-extract --use-dist-graph 1.0 --cache-percentage 0.93 > ${log_dir}/xgnn_graphsage_cf_5.log 2> ${log_dir}/xgnn_graphsage_cf_5.log.err


# parse data
python parse_res.py -d ${log_dir} > factor_analysis.res
# figure it by gnuplot, the output figure is factor-analysis.eps
gnuplot figure.plt
