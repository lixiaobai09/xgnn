outputfname = "placement-solver-cf-fig-b.eps"
dat_file='placement_solver_cf.res'
...
## Y-axis
set ylabel "Time (sec)" offset 0.5,0 font ",14"
set yrange [0:2.7]
set ytics ("0" 0, "" 0.5, "1" 1, "" 1.5, "2" 2, "" 2.5)
set ytics offset 0.2,0 #format "%.1f" #nomirror
